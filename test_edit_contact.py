...
class test_edit_contact(unittest.TestCase):
    ...
    def edit_contact(self, wd):
        ...
        wd.find_element_by_name("company").send_keys("asdfg")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89257788625")
        wd.find_element_by_name("address2").click()
        wd.find_element_by_name("address2").clear()
        wd.find_element_by_name("address2").send_keys("erty")
        wd.find_element_by_name("notes").click()
        wd.find_element_by_name("notes").clear()
        wd.find_element_by_name("notes").send_keys("5")
    ...
    def test_test_edit_contact(self):
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd)
        self.edit_contact(wd)
